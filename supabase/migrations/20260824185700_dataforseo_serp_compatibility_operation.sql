...
BEGIN
  ...
  SELECT conname
   ...
   ORDER BY CASE WHEN conname = 'ck_integration_capabilities_operation_kind_serp_compatibility' THEN 0 ELSE 1 END
   LIMIT 1;
  ...
  ALTER TABLE public.integration_capabilities
    ADD CONSTRAINT ck_integration_capabilities_operation_kind_serp_compatibility
