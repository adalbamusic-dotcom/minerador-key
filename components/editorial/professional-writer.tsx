...
import { writerGuardianApprovalBlockingCount, writerGuardianPanelSummary } from "@/lib/redator/guardian-panel-summary";
...
export function ProfessionalWriter({ initialArticleId = null, initialDocumentId = null }: { initialArticleId?: string | null; initialDocumentId?: string | null }) {
  ...
  const guardianSummary = writerGuardianPanelSummary(guardianReport, localGuardian);
