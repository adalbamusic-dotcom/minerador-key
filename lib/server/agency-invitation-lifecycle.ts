...
export const AGENCY_INVITATION_PRODUCTION_TTL_HOURS = 12;
export const AGENCY_INVITATION_DEVELOPMENT_TTL_HOURS = 2;
export const AGENCY_INVITATION_PRODUCTION_TTL_MS = AGENCY_INVITATION_PRODUCTION_TTL_HOURS * 60 * 60 * 1000;
