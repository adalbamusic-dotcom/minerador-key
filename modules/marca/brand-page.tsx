...
import { BrandExpertsPanel } from "./brand-experts-panel";
import { BrandSkillsPanel } from "./brand-skills-panel";
...
const sections = [["visao", "Visão geral"], ["site", "Site e Sitemap"], ["dna", "Identidade da marca"], ["materiais", "Materiais"], ["skills", "Skills e prompts"], ["equipe", "Equipe"], ["configuracoes", "Configurações"]] as const;
...
export function BrandPage({ initialSection = "visao" }: { initialSection?: string }) {
  ...
  return <>
    ...
    <main className="mx-auto max-w-7xl space-y-6 p-4 sm:p-6 lg:p-8">
      ...
      {section === "skills" && <div className="space-y-8"><BrandSkillsPanel brandId={activeBrand.id}/><div className="border-t border-divider pt-8"><LocalCollection title="Prompts" count={pipeline.prompts.length} description="Prompts permanentes ou específicos de artigo. Contrato atual preservado; a reconstrução é uma tarefa própria."/></div></div>}
