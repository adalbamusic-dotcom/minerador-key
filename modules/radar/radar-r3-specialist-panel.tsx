...
import { RADAR_INTENT_NOT_CONCLUDED, radarDeclaredArticleIntent } from "@/lib/radar/editorial-identity";
...
/*
 * O FORMULÁRIO DE MATERIAL SAIU DAQUI.
 *
 * Registrar um vídeo não é falar com um profissional. O bloco de entrada mudou
 * para a área Vídeos, que é dona desse processo; esta área ficou só com o que
 * depende de uma pessoa real — pauta, pedido, contribuição, revisão.
 */
export function RadarR3SpecialistPanel({ model, onTopicChange, onTopicRemove, onTopicMove, onTopicAdd, onTopicReview, onTopicUndo, onTopicRedo, canUndoTopics = false, canRedoTopics = false, onTopicAdjacent, topicQueuePosition, topicQueueTotal, showLocalFixture = false, expertContext = null, onExpertEvidenceChange }: RadarR3SpecialistPanelProps) {
